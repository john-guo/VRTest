...
#ifndef DIRECT3D11_H_INCLUDED
#define DIRECT3D11_H_INCLUDED
...
*/
class __declspec(dllexport) BaseDirect3D11 : public IDirect3D11
{
public:
	BaseDirect3D11(IDirect3D11* pD3D);
	virtual ~BaseDirect3D11();
